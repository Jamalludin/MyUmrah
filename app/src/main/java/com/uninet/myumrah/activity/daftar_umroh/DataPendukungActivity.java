...
public class DataPendukungActivity extends AbstracGenericActivity implements DataTambahanView,AdapterView.OnItemSelectedListener{
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tahunSakit1.setAdapter(new ArrayAdapter<String>(DataPendukungActivity.this,
                android.R.layout.simple_spinner_dropdown_item, tahunSakitArray));
        tahunSakit2.setAdapter(new ArrayAdapter<String>(DataPendukungActivity.this,
                android.R.layout.simple_spinner_dropdown_item, tahunSakitArray));
        tahunSakit3.setAdapter(new ArrayAdapter<String>(DataPendukungActivity.this,
                android.R.layout.simple_spinner_dropdown_item, tahunSakitArray));

        super.getMont();
        lamaSakit1.setAdapter(new ArrayAdapter<String>(DataPendukungActivity.this,
                android.R.layout.simple_spinner_dropdown_item, lamaList));
        lamaSakit2.setAdapter(new ArrayAdapter<String>(DataPendukungActivity.this,
                android.R.layout.simple_spinner_dropdown_item, lamaList));
        lamaSakit3.setAdapter(new ArrayAdapter<String>(DataPendukungActivity.this,
                android.R.layout.simple_spinner_dropdown_item, lamaList));
        ...
        simpanData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                jamaah.setJamaahPenyakits(jamaahPenyakits);
    ...
    public void provinsi(String provinsi) {
        ...
        try {
            ...
            pilihPovinsi.setAdapter(new ArrayAdapter<String>(DataPendukungActivity.this,
    ...
    public void kabupaten(String kabupaten) {
        ...
        try {
            ...
            pilihKabupaten.setAdapter(new ArrayAdapter<String>(DataPendukungActivity.this,
    ...
    public void kecamatan(String kecamatan) {
        ...
        try {
            ...
            pilihKecamatan.setAdapter(new ArrayAdapter<String>(DataPendukungActivity.this,
    ...
    public void kelurahan(String kelurahan) {
        ...
        try {
            ...
            pilihKelurahan.setAdapter(new ArrayAdapter<String>(DataPendukungActivity.this,
    ...
    public void ukuranBaju(String baju) {
        ...
        try {
            ...
            ukuranBaju.setAdapter(new ArrayAdapter<String>(DataPendukungActivity.this,
    ...
    public void mahram(String mahram) {
        ...
        try {
            ...
            statusMahram.setAdapter(new ArrayAdapter<String>(DataPendukungActivity.this,
    ...
    public void pendidikan(String pendidikan) {
        ...
        try {
            ...
            pendidikanLast.setAdapter(new ArrayAdapter<String>(DataPendukungActivity.this,
    ...
    public void pekerjaan(String pekerjaan) {
        ...
        try {
            ...
            pekerjaanList.setAdapter(new ArrayAdapter<String>(DataPendukungActivity.this,
    ...
    public void penyakit(String penyakit) {
        ...
        try {
            ...
            spinnerPenyakit1.setAdapter(new ArrayAdapter<String>(DataPendukungActivity.this,
                    android.R.layout.simple_spinner_dropdown_item, penyakitList));
            spinnerPenyakit2.setAdapter(new ArrayAdapter<String>(DataPendukungActivity.this,
                    android.R.layout.simple_spinner_dropdown_item, penyakitList));
            spinnerPenyakit3.setAdapter(new ArrayAdapter<String>(DataPendukungActivity.this,
                    android.R.layout.simple_spinner_dropdown_item, penyakitList));
    ...
    public void hubungan(String hubungan) {
        ...
        try {
            ...
            hubDaruratList.setAdapter(new ArrayAdapter<String>(DataPendukungActivity.this,
